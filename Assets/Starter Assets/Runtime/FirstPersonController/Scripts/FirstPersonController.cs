...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private bool leftGravity;
        private bool rightGravity;
        private bool topGravity;
        private bool bottomGravity;

        private bool actGravity = false;
        ...
        {
            if (bottomGravity && actGravity)
            {
                actGravity = false;
                characterTrans.rotation = Quaternion.Euler(0, 0, 0);

            }
            else if (topGravity && actGravity)
            {
                actGravity = false;
                characterTrans.rotation = Quaternion.Euler(180, 0, 0);

            }
            else if (leftGravity && actGravity)
            {
                actGravity = false;
                characterTrans.rotation = Quaternion.Euler(0, 0, -90);

            }
            else if (rightGravity && actGravity)
            {
                actGravity = false;
                characterTrans.rotation = Quaternion.Euler(0, 0, 90);
